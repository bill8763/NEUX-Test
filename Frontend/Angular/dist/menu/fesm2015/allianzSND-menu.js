...
import { APIFactory, APIDispatch, APPError, Language, APPMODE, DefaultLoginMgr, AppRouter, TranslateService, CheckPermissionService, ConfigToken, CoreModule } from '@allianzSND/core';
...
class MenuService {
     ...
     * @param {?} errorHandler
     */
    constructor(APIFactory$$1, dispatcher, errorHandler) {
...
class MenuComponent {
     ...
     * @param {?} APP_CONFIG
     */
    constructor(loginMgr, router, injector, translateService, APIFactory$$1, dispatcher, checkPermissionService, menuService, routeReuseStrategy, APP_CONFIG) {
