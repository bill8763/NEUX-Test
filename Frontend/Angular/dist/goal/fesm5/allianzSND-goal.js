...
import { v4 } from 'uuid';
import { __awaiter, __generator, __decorate, __metadata, __read } from 'tslib';
 ...
 */
/** @type {?} */
var goalSettingStepToken = new InjectionToken('goalSettingStep');
/** @type {?} */
var goalValidToken = new InjectionToken('GoalValidExtension');
/** @type {?} */
var goalSettingShowRuleToken = new InjectionToken('goalSettingShowRule');
/** @type {?} */
var GoalSubmitExtensionToken = new InjectionToken("GoalSubmitExtension");
...
var GoalSettingSetExpectedAPI = /** @class */ (function () {
    ...
    function () {
         ...
         * @return {?}
         */
        function (observer) { return __awaiter(_this, void 0, void 0, function () {
...
var GoalSettingService = /** @class */ (function () {
    function GoalSettingService(dispatcher, APIFactory$$1, goalStore, errorHandler, goalSettingStep, yearConfigExtension, goalSettingExtension, dataSyncService, profileCodeService) {
        var _this = this;
