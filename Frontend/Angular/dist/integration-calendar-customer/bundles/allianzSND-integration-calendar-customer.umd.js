(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@allianz/ngx-ndbx'), require('@allianz/ngx-ndbx/icon'), require('@angular/common'), require('@allianzSND/ui'), require('@allianz/ngx-ndbx/formfield'), require('@allianz/ngx-ndbx/datefield'), require('@angular/animations'), require('@allianz/ngx-ndbx/input'), require('@allianz/ngx-ndbx/progressbar'), require('@allianz/ngx-ndbx/grid'), require('@angular/core'), require('rxjs/operators'), require('uuid'), require('date-fns'), require('@allianzSND/core'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@allianzSND/integration-calendar-customer', ['exports', '@angular/forms', '@allianz/ngx-ndbx', '@allianz/ngx-ndbx/icon', '@angular/common', '@allianzSND/ui', '@allianz/ngx-ndbx/formfield', '@allianz/ngx-ndbx/datefield', '@angular/animations', '@allianz/ngx-ndbx/input', '@allianz/ngx-ndbx/progressbar', '@allianz/ngx-ndbx/grid', '@angular/core', 'rxjs/operators', 'uuid', 'date-fns', '@allianzSND/core', 'rxjs'], factory) :
    (factory((global.allianzSND = global.allianzSND || {}, global.allianzSND['integration-calendar-customer'] = {}),global.ng.forms,global.ngxNdbx,global.icon,global.ng.common,global.ui,global.formfield,global.datefield,global.ng.animations,global.input,global.progressbar,global.grid,global.ng.core,global.rxjs.operators,global.uuid,global.dateFns,global.i1,global.rxjs));
}(this, (function (exports,forms,ngxNdbx,icon,common,ui,formfield,datefield,animations,input,progressbar,grid,i0,operators,uuid,dateFns,i1,rxjs) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var calendarEditMetaControllerToken = new i0.InjectionToken("calendarEditMetaController");
    /** @type {?} */
    var calendarDetailMetaControllerToken = new i0.InjectionToken("calendarDetailMetaController");
    ...
    var DefaultCalendarEditMetaController = /** @class */ (function () {
         ...
         */
            function (data) {
                ...
                if (data['StartTime']) {
                    data['StartDate'] = dateFns.startOfDay(new Date(data['StartTime']));
                    data['StartTime'] = new Date(data['StartTime']);
                }
                else {
                    data['StartDate'] = data["ViewDate"];
                    data['StartTime'] = dateFns.addHours(this.toFiveUnit(this.combineDateTime(data["ViewDate"], new Date())), 1);
                    if (!IsAllDay)
                        data['StartDate'] = data['StartTime'];
                }
                if (data['EndTime']) {
                    data['EndDate'] = dateFns.startOfDay(new Date(data['EndTime']));
                    data['EndTime'] = new Date(data['EndTime']);
                }
                else {
                    data['EndDate'] = dateFns.startOfDay(data['StartDate']);
                    data['EndTime'] = dateFns.addHours(data['StartTime'], 1);
                    if (!IsAllDay)
         ...
         */
            function (column, value, groupId, index, data, validationResult) {
                ...
                if (column === 'IsAllDay') {
                    ...
                    if (!value)
                        data["StartDate"] = dateFns.startOfDay(new Date());
                    else
                    ...
                    //CHECK if to > from+15
                    if (!value)
                        data["EndDate"] = dateFns.startOfDay(new Date());
                    else
                        data["EndDate"] = value;
                    this.checkEndBeforeStartError(data, validationResult);
                }
         ...
         */
            function (data, validationResult) {
                if (data["IsAllDay"] === 'Y') {
                    data["StartDateTime"] = dateFns.startOfDay(data["StartDate"]);
                    data["EndDateTime"] = dateFns.startOfDay(data["EndDate"]);
                }
                else {
         ...
         */
            function (date) {
                ...
                var now = date;
                /** @type {?} */
                var minutes = dateFns.getMinutes(now);
                /** @type {?} */
                var toAdd = minutes % 5 === 0 ? 0 : 5 - (minutes % 5);
                return dateFns.addMinutes(now, toAdd);
            };
        /**
         * @private
         * @param {?} fromDate
         ...
         */
            function (fromDate, fromTime) {
                ...
                console.log("GetMonth:", dateFns.getMonth(fromDate));
                /** @type {?} */
                var from = new Date(dateFns.getYear(fromDate), dateFns.getMonth(fromDate), dateFns.getDate(fromDate), dateFns.getHours(fromTime), dateFns.getMinutes(fromTime));
                from = this.toFiveUnit(from);
                return dateFns.addHours(from, 1);
            };
        /**
         * @private
         * @param {?} data
         ...
         */
            function (data, validationResult) {
                ...
                /** @type {?} */
                var IsAllDay = data['IsAllDay'] === 'Y';
                if (!(dateFns.isSameDay(data["StartDate"], data["EndDate"]) || dateFns.isAfter(data["EndDate"], data["StartDate"]))) {
                ...
                if (!IsAllDay) {
                    ...
                    if (dateFns.isBefore(end, dateFns.addMinutes(from, 15))) {
         ...
         */
            function (date, time) {
                return new Date(dateFns.getYear(date), dateFns.getMonth(date), dateFns.getDate(date), dateFns.getHours(time), dateFns.getMinutes(time));
            };
        /**
         * @private
         * @param {?} IsAllDay
         ...
         */
             ...
             * @param {?} x
             * @return {?}
             */function (x) { return new ui.SelectOption(x.getCode(), _this.profileCodeService.convertCode2Text(x.getTypeId(), x.getCode())); }));
            };
        ...
        DefaultCalendarEditMetaController.ctorParameters = function () {
            return [
     ...
     */
    /** @type {?} */
    var customerEditMetaControllerToken = new i0.InjectionToken("customerEditMetaController");
    /** @type {?} */
    var customerDetailMetaControllerToken = new i0.InjectionToken("customerDetailMetaController");
    /** @type {?} */
    var customerContactEditMetaControllerToken = new i0.InjectionToken("customerContactEditMetaController");
    /** @type {?} */
    var customerContactDetailMetaControllerToken = new i0.InjectionToken("customerContactDetailMetaController");
    /** @type {?} */
    var customerFilterMetaControllerToken = new i0.InjectionToken("customerFilterMetaController");
    /** @type {?} */
    var customerCriteriaSearchToken = new i0.InjectionToken("customerCriteriaSearch");
    /** @type {?} */
    var customerImportDisplayToken = new i0.InjectionToken("customerImportDisplay");
    /** @type {?} */
    var addProgressPointToken = new i0.InjectionToken("addProgressPoint");
    /** @type {?} */
    var customerShowRuleToken = new i0.InjectionToken("customerShowRule");
    ...
    var CalendarEditComponent = /** @class */ (function (_super) {
        ...
        function CalendarEditComponent(elementRef, metaService, profileCodeService, metaParser, metaExecutor, defaultMetaController, customMetaController, addProgressPoint, showRule) {
            ...
            _this.isMetaDataDone = new i0.EventEmitter();
            _this.isSaveClickChange = new i0.EventEmitter();
            _this.editType = 'add';
            _this.saveEvent = new i0.EventEmitter();
        ...
        CalendarEditComponent.ctorParameters = function () {
            return [
                ...
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [calendarEditMetaControllerToken,] }] },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [addProgressPointToken,] }] },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [i1.showRuleToken,] }] }
            ];
        };
        CalendarEditComponent.propDecorators = {
            isMetaDataDone: [{ type: i0.Output }],
            isSaveClick: [{ type: i0.Input }],
            isSaveClickChange: [{ type: i0.Output }],
            clientID: [{ type: i0.Input }],
            customerItemList: [{ type: i0.Input }],
            translateMap: [{ type: i0.Input }],
            viewDate: [{ type: i0.Input }],
            todayCalendarEvent: [{ type: i0.Input }],
            saveEvent: [{ type: i0.Output }],
            customerClientID: [{ type: i0.Input }],
    ...
    var DefaultCalendarDetailMetaController = /** @class */ (function () {
        ...
        /** @nocollapse */ DefaultCalendarDetailMetaController.ngInjectableDef = i0.defineInjectable({ factory: function DefaultCalendarDetailMetaController_Factory() { return new DefaultCalendarDetailMetaController(); }, token: DefaultCalendarDetailMetaController, providedIn: "root" });
    ...
    var CalendarDetailComponent = /** @class */ (function (_super) {
        ...
        CalendarDetailComponent.ctorParameters = function () {
            return [
                ...
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [calendarDetailMetaControllerToken,] }] }
            ];
        };
        CalendarDetailComponent.propDecorators = {
            isMetaDataDone: [{ type: i0.Output }],
            calendarEventDetail: [{ type: i0.Input }],
            customerClientName: [{ type: i0.Input }]
        };
        return CalendarDetailComponent;
    }(i1.DisplayMetaComponent));
    ...
    var CalendarEventDetail = /** @class */ (function () {
        function CalendarEventDetail(clientID, calendarID, customerClientID, title, location, calendarType, isAllDay, start, end, isAlert, alert1, alert2, alert3, remark, color) {
            ...
            this._alert3 = alert3;
            this._remark = remark;
            if (i1.StringUtils.isEmpty(this._customerClientID))
    ...
    var DefaultCustomerCriteriaSearch = /** @class */ (function () {
            ...
            function (criteria) {
                 ...
                 */function (array, key) {
                    ...
                    if (key == 'Birthday') {
                        ...
                        conditions.push(new i1.ORCompoundRestriction(birthdayRestriction));
                    }
                        ...
                        if (array.length != 2) {
                            ...
                            if (datasource == 'E') {
                                conditions.push(new i1.EqualRestriction('DataSource', ['OPUS']));
                            }
                            else {
                                conditions.push(new i1.NotEqualRestriction('DataSource', ['OPUS']));
                            }
                        }
                    }
                        ...
                        if (completenessRestriction_1.length != 0) {
                            conditions.push(new i1.ORCompoundRestriction(completenessRestriction_1));
                        }
                    }
                    else {
                        conditions.push(new i1.InRestriction(key, array));
                    }
                }));
                return conditions;
            };
        ...
        DefaultCustomerCriteriaSearch.ctorParameters = function () {
            return [
                { type: i1.ProfileCodeService }
            ];
        };
    ...
    var CustomerService = /** @class */ (function () {
         ...
         */
            function (clientID) {
                if (i1.StringUtils.isEmpty(clientID)) {
                    ...
                    return rxjs.from(this.dispatcher.dispatch(customerDetailAPI).toPromise().then(( /**
                     * @param {?} resp
                     * @return {?}
                     */function (resp) {
        ...
        CustomerService.ctorParameters = function () {
            return [
                ...
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerCriteriaSearchToken,] }] }
            ];
        };
        /** @nocollapse */ CustomerService.ngInjectableDef = i0.defineInjectable({ factory: function CustomerService_Factory() { return new CustomerService(i0.inject(i1.APIDispatch), i0.inject(i1.APIFactory), i0.inject(i1.ProfileCodeService), i0.inject(DefaultCustomerCriteriaSearch), i0.inject(customerCriteriaSearchToken, 8)); }, token: CustomerService, providedIn: "root" });
    ...
    var CustomerUtils = /** @class */ (function () {
                ...
                if (codeArray != undefined) {
                    try {
                        for (var codeArray_1 = __values(codeArray), codeArray_1_1 = codeArray_1.next(); !codeArray_1_1.done; codeArray_1_1 = codeArray_1.next()) {
                            ...
                            options.push(new i1.SelectOption(code.getCode(), code.displayText));
                        }
                    }
                    catch (e_1_1) {
                        e_1 = { error: e_1_1 };
        ...
        CustomerUtils.ctorParameters = function () {
            return [
                { type: i1.ProfileCodeService },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [i1.showRuleToken,] }] },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerShowRuleToken,] }] }
            ];
        };
        /** @nocollapse */ CustomerUtils.ngInjectableDef = i0.defineInjectable({ factory: function CustomerUtils_Factory() { return new CustomerUtils(i0.inject(i1.ProfileCodeService), i0.inject(i1.showRuleToken, 8), i0.inject(customerShowRuleToken, 8)); }, token: CustomerUtils, providedIn: "root" });
    ...
    var CalendarComponent = /** @class */ (function () {
            ...
            function (activeTabIndex) {
                ...
                switch (activeTabIndex) {
                    ...
                    case 2:
                        this.viewType = this.MONTH;
                        this.calcuContentHeight();
                        start = dateFns.startOfMonth(this.viewDate);
                        end = dateFns.endOfMonth(this.viewDate);
                        //count current time is have data
                        break;
                    // WEEK
                    case 1:
                        this.viewType = this.WEEK;
                        start = dateFns.startOfWeek(this.viewDate, { weekStartsOn: 1 });
                        end = dateFns.endOfWeek(this.viewDate, { weekStartsOn: 1 });
                        //count current time is have data
                    ...
                    case 0:
                        ...
                        start = dateFns.startOfDay(this.viewDate);
                        end = dateFns.endOfDay(this.viewDate);
                        //count current time is have data
                        this.scrollToCurrentTime();
        ...
        CalendarComponent.prototype.onViewDateChange =
            ...
            function (viewDateChange) {
                ...
                console.debug('this.viewDate:', this.viewDate, dateFns.isSameMonth(this.viewDate, val));
                if (this.isPad() && (dateFns.isSameMonth(this.viewDate, val) && this.viewType === this.MONTH)) {
                    this.viewDate = val;
                    return;
                }
                else {
         ...
         */
            function () {
                ...
                this.calendarEventEdit = new CalendarEventDetail('', '', null, '', '', null, 'N', currentTime, dateFns.addMinutes(currentTime, 15), 'Y', '8', '', '', '', null);
                this.loadViewDateCalendarEventList();
                this.onToggleAppointmentModal(true);
            };
                 ...
                 */function (data) {
                    ...
                    try {
                        for (var data_1 = __values(data), data_1_1 = data_1.next(); !data_1_1.done; data_1_1 = data_1.next()) {
                            ...
                            temp_array.push(new i1.SelectOption(custItem.clientID, _this_1.customerUtils.convertNameToShow(custItem.firstName, custItem.lastName)));
                        }
                    }
                    catch (e_2_1) {
                        e_2 = { error: e_2_1 };
    ...
    var CustomerDetailComponent = /** @class */ (function (_super) {
        ...
        function CustomerDetailComponent(dateUtils, profileCodeService, changeDetctor, metaService, customerUtils, inputExecutor, metaParser, showRule, customMetaController) {
            ...
            _this.onEditDetail = new i0.EventEmitter();
            _this.onCallPhone = new i0.EventEmitter();
            _this.onDeleteDetail = new i0.EventEmitter();
            _this.onAddAppointment = new i0.EventEmitter();
            _this.followChange = new i0.EventEmitter();
         ...
         */
            function () {
                 ...
                 * @param {?} x
                 * @return {?}
                 */function (x) { return _this._data[x.id] === null || _this._data[x.id] === undefined || i1.StringUtils.isEmpty(_this._data[x.id]) || _this._data[x.id] === _this.dash; }))
                        .reduce(( /**
                 * @param {?} acc
                 * @param {?} cur
                 * @return {?}
            ...
            function (customerDetail) {
                 ...
                 */function (col) {
                    if (col.id === 'BirthdayDisplay')
                        customerDetail.BirthdayDisplay = i1.StringUtils.isNotEmpty(customerDetail.Birthday) ? _this.toBirthdayStr() : _this.dash;
                    else
                        customerDetail[col.id] = i1.StringUtils.isEmpty(customerDetail[col.id]) ? _this.dash : customerDetail[col.id];
                }));
            };
        /**
         * @private
         ...
         */
            function (addressObj) {
                if (this.showRule)
                    ...
                    /** @type {?} */
                    var array = [];
                    if (i1.StringUtils.isNotEmpty(addressObj.Country))
                        array.push(addressObj.Country);
                    if (i1.StringUtils.isNotEmpty(addressObj.City))
                        array.push(addressObj.City);
                    if (i1.StringUtils.isNotEmpty(addressObj.Area))
                        array.push(addressObj.Area);
                    if (i1.StringUtils.isNotEmpty(addressObj.Zipcode))
                        array.push(addressObj.Zipcode);
                    if (i1.StringUtils.isNotEmpty(addressObj.Address))
        ...
        CustomerDetailComponent.ctorParameters = function () {
            return [
                ...
                { type: i1.MetaService },
                { type: CustomerUtils },
                { type: i1.InputExecutor },
                { type: i1.DefaultMetaParser },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [i1.showRuleToken,] }] },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerDetailMetaControllerToken,] }] }
            ];
        };
        CustomerDetailComponent.propDecorators = {
            ...
            data: [{ type: i0.Input }],
            detailPostTemp: [{ type: i0.ViewChildren, args: ['detailPostTemp',] }]
        };
    ...
    var CustomerStoreService = /** @class */ (function () {
        function CustomerStoreService() {
            ...
            this._stateBehaviorSubject = new rxjs.BehaviorSubject(this._customerState);
            this._detailBehaviorSubject = new rxjs.BehaviorSubject(this._customerDetail);
            this._listBehaviorSubject = new rxjs.BehaviorSubject(this._customerList);
            this._criteriaBehaviorSubject = new rxjs.BehaviorSubject(this._customerCriteria);
            this._detailIDSubject = new rxjs.BehaviorSubject(this._customerDetail.ClientID);
        }
        /**
         * @param {?} state
         * @return {?}
    ...
    var CustomerEditComponent = /** @class */ (function (_super) {
        ...
        function CustomerEditComponent(customerUtils, changeDetector, elementRef, router, translateService, defaultMetaController, profileCodeService, metaParser, metaExecutor, customMetaController, customerStoreService, metaService, addProgressPoint) {
            ...
            _this.metaService = metaService;
            _this.addProgressPoint = addProgressPoint;
            _this.sendContentHeight = new i0.EventEmitter();
         ...
         */
            function () {
                 ...
                 */function (customerID) {
                    ...
                    if (i1.StringUtils.isEmpty(customerID)) {
                        //ADD
                        _this.edit_type = "add";
                    }
                    else {
         ...
         */
            function () {
                ...
                if (this.edit_type === 'add') {
                    ...
                    this.disableAge = i1.StringUtils.isNotEmpty(this._data.Birthday);
        ...
        CustomerEditComponent.ctorParameters = function () {
            return [
                ...
                { type: i1.DefaultMetaParser },
                { type: i1.APIExecutor },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerEditMetaControllerToken,] }] },
    ...
    var CustomerFilterComponent = /** @class */ (function (_super) {
        ...
        function CustomerFilterComponent(metaService, profileCodeService, metaParser, metaExecutor, customMetaController) {
            ...
            _this.doneCriteria = new i0.EventEmitter();
            _this.language = new i1.Language();
        ...
        CustomerFilterComponent.ctorParameters = function () {
            return [
                ...
                { type: i1.DefaultMetaParser },
                { type: i1.InputExecutor },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerFilterMetaControllerToken,] }] }
            ];
        };
    ...
    var CustomerImportComponent = /** @class */ (function () {
        ...
        CustomerImportComponent.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [i1.showRuleToken,] }] }
            ];
        };
    ...
    var CustomerListComponent = /** @class */ (function () {
        ...
        Object.defineProperty(CustomerListComponent.prototype, "isDefaultData", {
             ...
             */
            function () {
                return this.customerList.length == 0 && i1.StringUtils.isNotEmpty(this.filterType) && this.filterType == 'NONE';
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CustomerListComponent.prototype, "showSearchNoData", {
             ...
             * @return {?}
             */ function () {
                return this.customerList.length == 0 && i1.StringUtils.isNotEmpty(this.filterType) && this.filterType == 'SEARCH';
            },
            enumerable: true,
            configurable: true
        });
        ...
        CustomerListComponent.propDecorators = {
            ...
            onClickCustomerID: [{ type: i0.Input }]
        };
    ...
    var DefaultCustomerImportDisplay = /** @class */ (function () {
         ...
         */
            function (customer) {
                if (this.customImportDisplay)
                    ...
                    if (i1.StringUtils.isEmpty(customer.LastName)) {
        ...
        DefaultCustomerImportDisplay.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerImportDisplayToken,] }] }
            ];
        };
        /** @nocollapse */ DefaultCustomerImportDisplay.ngInjectableDef = i0.defineInjectable({ factory: function DefaultCustomerImportDisplay_Factory() { return new DefaultCustomerImportDisplay(i0.inject(customerImportDisplayToken, 8)); }, token: DefaultCustomerImportDisplay, providedIn: "root" });
    ...
    var CustomersComponent = /** @class */ (function () {
        ...
        function CustomersComponent(customerService, calendarService, translateService, deviceService, dateUtils, profileCodeService, customerUtils, router, customerStoreService, customerImportDisplay, notificationMgr, changeDetector, APP_CONFIG, showRule, customerShowRule, addProgressPoint) {
            ...
            this.contactSaveSubject = new rxjs.Subject();
        }
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    ...
                                    return [3 /*break*/, 10];
                                case 4:
                                    if (!(state == CUSTOMER_STATE.EDIT && this.customerState != CUSTOMER_STATE.EDIT && this.customerState == CUSTOMER_STATE.FIRST))
                                        return [3 /*break*/, 7];
                                    // edit/click page click last page
                                    this.customerList = this.pre_customerList;
                                    this.filterCriteria = this.pre_criteria;
                                    if (!!i1.StringUtils.isEmpty(this.currentCustomer.ClientID))
                                        return [3 /*break*/, 6];
                                    return [4 /*yield*/, this.onGetCustomerDetailByID(this.currentCustomer.ClientID)];
                                case 5:
                                    _a.sent();
                                ...
                                case 6:
                                    ...
                                    return [3 /*break*/, 10];
                                case 7:
                                    if (!(this.customerState == CUSTOMER_STATE.FIRST && state == CUSTOMER_STATE.DISPLAY))
                                        return [3 /*break*/, 9];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.customerService.getCustomerList(this.filterCriteria, this.customerListPageInfo).pipe(operators.take(1)).toPromise()];
                            case 1:
                                data = _a.sent();
                                ...
                                if ((!this.filterCriteria.hasCriteria())) {
                                    ...
                                    this.filterType = i1.StringUtils.isNotEmpty(this.filterCriteria.keyword) ? 'SEARCH' : 'FILTER';
                                }
         ...
         */
            function (list) {
                if (this.customerShowRule) {
                     ...
                     */function (n1, n2) {
                        /** @type {?} */
                        var n1_name = i1.StringUtils.isEmpty(n1.lastName) ? '' : n1.lastName;
                        /** @type {?} */
                        var n2_name = i1.StringUtils.isEmpty(n2.lastName) ? '' : n2.lastName;
         ...
         */
            function (customerClientID) {
                ...
                currentTime = dateFns.addMinutes(currentTime, (5 - dateFns.getMinutes(currentTime) % 5)); // adjust minutes to next 5 minutes
                currentTime = dateFns.addHours(currentTime, 1);
                this.calendarEventDetail = new CalendarEventDetail('', '', customerClientID, '', '', null, 'N', currentTime, dateFns.addMinutes(currentTime, 15), 'Y', '8', null, '', '', null);
                /** @type {?} */
                var queryDate = new Date(dateFns.getYear(this.viewDate), dateFns.getMonth(this.viewDate), dateFns.getDate(this.viewDate), 0, 0, 0);
                this.calendarService.getCalendarEventList(queryDate, dateFns.subMinutes(dateFns.addDays(this.viewDate, 1), 1), '')
                    .subscribe(( /**
             * @param {?} data
             * @return {?}
             */function (data) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                this.notificationMgr.pushNotification(i1.NotificationType.ContactPermissionError, null);
        ...
        CustomersComponent.propDecorators = {
            calendarEditComponent: [{ type: i0.ViewChild, args: [CalendarEditComponent,] }]
        };
    ...
    var CustomerContactDetailComponent = /** @class */ (function (_super) {
        ...
        CustomerContactDetailComponent.ctorParameters = function () {
            return [
                { type: i1.MetaService },
                { type: i1.ProfileCodeService },
                { type: i1.DefaultMetaParser },
                { type: i1.InputExecutor },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerContactDetailMetaControllerToken,] }] }
            ];
        };
    ...
    var CustomerContactEditComponent = /** @class */ (function (_super) {
        ...
        CustomerContactEditComponent.ctorParameters = function () {
            return [
                { type: i1.MetaService },
                { type: i1.ProfileCodeService },
                { type: i1.DefaultMetaParser },
                { type: i1.InputExecutor },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [customerContactEditMetaControllerToken,] }] }
            ];
        };
        CustomerContactEditComponent.propDecorators = {
            data: [{ type: i0.Input }],
            saveSubject: [{ type: i0.Input }],
            save: [{ type: i0.Output }]
        };
    ...
    var CustomerAddContactNoteAPI = /** @class */ (function () {
         ...
         */
            function () {
                ...
                // If empty, don't save 
                if (!this.Data.Note) {
                    return rxjs.of(new i1.SQLiteResponse({
                        status: true
                    }, []));
                }
                else {
                     ...
                     */function (observer) {
                        ...
                        if (contactObj != undefined && dao != undefined) {
                            ...
                            contactExtObj = i1.TableUtils.fillTableColumn(contactExtObj, _this.Data);
                            contactExtObj.setValue('CustomerClientID', _this.Data.CustomerClientID);
                            if (_this.Data.ClientID != undefined && _this.Data.ClientID != '') {
                                contactObj.addRestriction(new i1.EqualRestriction('ClientID', [_this.Data.ClientID]));
                                contactExtObj.addRestriction(new i1.EqualRestriction('ClientID', [_this.Data.ClientID]));
         ...
         */
            function () {
                ...
                if (!this._id || (this._id.length == 0)) {
                    //Add
                    /** @type {?} */
                    var resp = new i1.SQLiteResponse({
                        "isSuccess": true
                    }, [defaultObj]);
                    return rxjs.of(resp);
                }
            ...
            function () {
                 ...
                 */function (observer) {
                    ...
                    if (base_dao != undefined) {
                        dao = new i1.ClientCustomDao(base_dao);
                        ...
                        if (customerObj && customerExtObj) {
                            ...
                            customerExtObj = i1.TableUtils.fillTableColumn(customerExtObj, _this.customerDetail);
                            ...
                            if (customerObj.getValue('ClientID') == '') {
                                ...
                                customerObj.addRestriction(new i1.EqualRestriction('ClientID', [_deletedClientID]));
                                customerExtObj.addRestriction(new i1.EqualRestriction('ClientID', [_deletedClientID]));
                                phoneInsertObj.addRestriction(new i1.EqualRestriction('CustomerClientID', [_deletedClientID]));
                                phoneInsertExtObj.addRestriction(new i1.EqualRestriction('CustomerClientID', [_deletedClientID]));
                                emailInsertObj.addRestriction(new i1.EqualRestriction('CustomerClientID', [_deletedClientID]));
                                emailInsertExtObj.addRestriction(new i1.EqualRestriction('CustomerClientID', [_deletedClientID]));
                                addressInsertObj.addRestriction(new i1.EqualRestriction('CustomerClientID', [_deletedClientID]));
                                addressInsertExtObj.addRestriction(new i1.EqualRestriction('CustomerClientID', [_deletedClientID]));
                            ...
                            try {
                                ...
                                for (var _d = __values(_this.customerDetail.tel), _e = _d.next(); !_e.done; _e = _d.next()) {
                                    ...
                                    if (phoneInsertObj && phone.Tel) {
                                        ...
                                        phoneInsertExtObj = i1.TableUtils.fillTableColumn(phoneInsertExtObj, phone);
                                        //insert
                            ...
                            try {
                                ...
                                for (var _f = __values(_this.customerDetail.email), _g = _f.next(); !_g.done; _g = _f.next()) {
                                    ...
                                    if (emailInsertObj && email.Email) {
                                        ...
                                        emailInsertExtObj = i1.TableUtils.fillTableColumn(emailInsertExtObj, email);
                                        //insert
                                ...
                                for (var _h = __values(_this.customerDetail.address), _j = _h.next(); !_j.done; _j = _h.next()) {
                                    ...
                                    if (addressInsertObj) {
                                        if (!_this._judgeIsAddressEmpty(address)) {
                                            ...
                                            addressInsertExtObj = i1.TableUtils.fillTableColumn(addressInsertExtObj, address);
                                            //insert
            ...
            function () {
                 ...
                 */function (observer) {
                    ...
                    if (calendarObj != undefined && dao != undefined) {
                        ...
                        calendarExtObj.addRestriction(new i1.EqualRestriction('ClientID', [_this._clientID]));
            ...
            function () {
                 ...
                 */function (observer) {
                    ...
                    if (calendarObj != undefined) {
                        ...
                        // fill extension
                        calendarExtObj = i1.TableUtils.fillTableColumn(calendarExtObj, _this.Data);
                        if (_this.Data["EditType"] === "edit") {
                            calendarObj.addRestriction(new i1.EqualRestriction("ClientID", [_this.Data.ClientID]));
                            calendarExtObj.addRestriction(new i1.EqualRestriction("ClientID", [_this.Data.ClientID]));
    ...
    exports.IntegrationCalendarCustomerModule = IntegrationCalendarCustomerModule;
    ...
    exports.DefaultCustomerCriteriaSearch = DefaultCustomerCriteriaSearch;
    ...
    exports.customerEditMetaControllerToken = customerEditMetaControllerToken;
    exports.customerDetailMetaControllerToken = customerDetailMetaControllerToken;
    exports.customerContactEditMetaControllerToken = customerContactEditMetaControllerToken;
    exports.customerContactDetailMetaControllerToken = customerContactDetailMetaControllerToken;
    exports.customerFilterMetaControllerToken = customerFilterMetaControllerToken;
    exports.customerCriteriaSearchToken = customerCriteriaSearchToken;
    exports.customerImportDisplayToken = customerImportDisplayToken;
    exports.addProgressPointToken = addProgressPointToken;
    exports.customerShowRuleToken = customerShowRuleToken;
    ...
    exports.CustomerStoreService = CustomerStoreService;
    ...
    exports.DefaultCalendarEditMetaController = DefaultCalendarEditMetaController;
    ...
    exports.CalendarEventSaveAPI = CalendarEventSaveAPI;
    exports.calendarEditMetaControllerToken = calendarEditMetaControllerToken;
    exports.calendarDetailMetaControllerToken = calendarDetailMetaControllerToken;
    exports.ɵu = DefaultCalendarDetailMetaController;
    exports.ɵt = CalendarDetailComponent;
    exports.ɵr = DefaultCalendarEditMetaController;
    exports.ɵq = CalendarEditComponent;
    exports.ɵv = CalendarFilterComponent;
    exports.ɵa = CalendarComponent;
    exports.ɵb = CalendarService;
    exports.ɵbh = CustomerContactDetailComponent;
    exports.ɵbi = CustomerContactEditComponent;
    exports.ɵbe = CustomerContactListComponent;
    exports.ɵbd = CustomerDetailComponent;
    exports.ɵbb = DefaultCustomerEditMetaController;
    exports.ɵba = CustomerEditComponent;
    exports.ɵm = DefaultCustomerCriteriaSearch;
    exports.ɵbf = CustomerFilterComponent;
    exports.ɵbg = CustomerImportComponent;
    exports.ɵbc = CustomerListComponent;
    exports.ɵy = DefaultCustomerImportDisplay;
    exports.ɵw = CustomersComponent;
    exports.ɵk = addProgressPointToken;
    exports.ɵg = customerContactDetailMetaControllerToken;
    exports.ɵf = customerContactEditMetaControllerToken;
    exports.ɵi = customerCriteriaSearchToken;
    exports.ɵe = customerDetailMetaControllerToken;
    exports.ɵd = customerEditMetaControllerToken;
    exports.ɵh = customerFilterMetaControllerToken;
    exports.ɵj = customerImportDisplayToken;
    exports.ɵl = customerShowRuleToken;
    exports.ɵc = CustomerService;
    exports.ɵx = CustomerStoreService;
    exports.ɵo = CustomerUtils;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=allianzSND-integration-calendar-customer.umd.js.map