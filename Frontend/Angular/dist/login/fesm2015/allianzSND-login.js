...
import { Injectable, ErrorHandler, NgModule, Component, Optional, Input, Output, EventEmitter, Inject, defineInjectable, inject, ViewChild, HostListener } from '@angular/core';
import { fromEvent } from 'rxjs';
import { Location, CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { APIFactory, APIDispatch, APPError, LoginResponse, LOGIN_TYPE, TimeoutService, CoreModule, Language, ValidationResult, SQLCommand, NotificationType, DefaultLoginMgr, DeviceService, DaoFactory, AppRouter, DataSyncTask, NotificationMgr, TranslateService, ConfigToken, AfterLoginToken, DefaultLoadingApp, LoadingAppToken } from '@allianzSND/core';
...
class LoginService {
     ...
     * @param {?} errorHandler
     */
    constructor(APIFactory$$1, dispatcher, timeoutService, errorHandler) {
...
/** @nocollapse */ LoginService.ngInjectableDef = defineInjectable({ factory: function LoginService_Factory() { return new LoginService(inject(APIFactory), inject(APIDispatch), inject(TimeoutService), inject(ErrorHandler)); }, token: LoginService, providedIn: "root" });
...
class LoadingComponent {
    /**
     * @param {?} router
     * @param {?} defaultLoadingAppHandler
     * @param {?} _location
     * @param {?} loadingAppHandler
     */
    constructor(router, defaultLoadingAppHandler, _location, loadingAppHandler) {
        this.router = router;
        this._location = _location;
        // progress bar 
        this.progressValue = 0.2;
        this.onProgressFinish = new EventEmitter();
        this.language = new Language();
...
LoadingComponent.ctorParameters = () => [
    { type: AppRouter },
    { type: DefaultLoadingApp },
    { type: Location, decorators: [{ type: Optional }] },
    { type: undefined, decorators: [{ type: Optional }, { type: Inject, args: [LoadingAppToken,] }] }
];
LoadingComponent.propDecorators = {
    progressValue: [{ type: Input }],
    onProgressFinish: [{ type: Output }]
};
...
export { LoginModule, LoadingComponent, LoginComponent, Region, LoginForm, LoginService, LoadingComponent as ɵc, LoginComponent as ɵa, LoginService as ɵb };

//# sourceMappingURL=allianzSND-login.js.map