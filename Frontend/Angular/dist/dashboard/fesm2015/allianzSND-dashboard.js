...
import { getYear, addDays, format, subDays, startOfDay, endOfDay } from 'date-fns';
import { CustomerService, CalendarService, CustomerFilterCriteria, CustomerUtils, IntegrationCalendarCustomerModule } from '@allianzSND/integration-calendar-customer';
import { CONTENTGAP, UIModule } from '@allianzSND/ui';
import { ProgressService, Tag } from '@allianzSND/progress';
import { __awaiter } from 'tslib';
import { Component, Input, Output, EventEmitter, ViewChild, ElementRef, Inject, ViewChildren, Optional, InjectionToken, Injectable, ErrorHandler, NgModule, HostListener, defineInjectable, inject, ChangeDetectionStrategy, ChangeDetectorRef } from '@angular/core';
import { TranslateService, Language, ConfigToken, showRuleToken, StringUtils, APIDispatch, APIFactory, DateUtils, APPError, DefaultLoginMgr, NotificationType, AppRouter, NotificationMgr, DataSyncService, NumberUtils, CoreModule, PageInfo, SelectOption, ProfileCodeService } from '@allianzSND/core';
import { ROLE, AgencyPlanStoreService, AgencyPlanAgentInfo } from '@allianzSND/goal';
 ...
 */
/** @type {?} */
const showDashboardRuleToken = new InjectionToken('showDashboardRule');
...
class DashboardService {
     ...
     */
    constructor(dispatcher, APIFactory$$1, dateUtils, errorHandler, showRule, showDashboardRule) {
...
/** @nocollapse */ DashboardService.ngInjectableDef = defineInjectable({ factory: function DashboardService_Factory() { return new DashboardService(inject(APIDispatch), inject(APIFactory), inject(DateUtils), inject(ErrorHandler), inject(showRuleToken, 8), inject(showDashboardRuleToken, 8)); }, token: DashboardService, providedIn: "root" });
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DashboardUiCardMsgComponent {
...
class DashboardPerformanceComponent {
    /**
     * @param {?} loginMgr
     */
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DashboardPerformanceTeamComponent {
    /**
     * @param {?} dashboardService
     * @param {?} loginMgr
     * @param {?} errorHandler
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DashboardPerformancePersonalComponent {
    /**
     * @param {?} dashboardService
     * @param {?} errorHandler
     * @param {?} router
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DashboardMessageComponent {
    /**
     * @param {?} translateService
     * @param {?} loginMgr
     * @param {?} errorHandler
...
export { DashboardModule, DashboardComponent, DashboardDetailComponent, DashboardListComponent, DashboardUiCardMsgComponent, DashboardMessageType, DashboardService, DashboardMessage, DashboardShowLoginInfo, showDashboardRuleToken, DashboardDetailComponent as ɵf, DashboardListComponent as ɵe, DashboardMessageComponent as ɵl, DashboardPerformancePersonalComponent as ɵk, DashboardPerformanceTeamComponent as ɵj, DashboardPerformanceComponent as ɵi, DashboardUiCardMsgComponent as ɵh, DashboardComponent as ɵa, showDashboardRuleToken as ɵc, DashboardService as ɵb };

//# sourceMappingURL=allianzSND-dashboard.js.map