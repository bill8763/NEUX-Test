...
import { StringUtils, APIFactory, APIDispatch, ProfileCodeService, ValidationResult, DateUtils, ClientCustomDao, EqualRestriction, OrderByRestriction, LimitRestriction, OffsetRestriction, Language, CoreModule, PageInfo, TranslateService, DeviceService, ExtensionService, ORCompoundRestriction, GreaterOrEqualRestriction, LessOrEqualRestriction, LikeRestriction, AndCompoundRestriction, InRestriction, NotEqualRestriction, SQLCommand } from '@allianzSND/core';
...
var CustomerService = /** @class */ (function () {
    function CustomerService(dispatcher, dateUtils, APIFactory$$1, profileCodeService) {
 ...
 */
/** @type {?} */
var syncCustomerToken = new InjectionToken('syncCustomer');
/** @type {?} */
var storeCustomerToken = new InjectionToken("storeCustomer");
/** @type {?} */
var customerActionToken = new InjectionToken("customerAction");
/** @type {?} */
var showCustomerRuleToken = new InjectionToken("showCustomerRule");
    ...
    function () {
        ...
        if (this.customerStore) {
            ...
            function (state$$1) {
                ...
                if (state$$1 == CUSTOMER_STATE.EDIT_SAVED && _this_1.customerState != CUSTOMER_STATE.EDIT_SAVED) {
                ...
                else if (state$$1 == CUSTOMER_STATE.EDIT && _this_1.customerState != CUSTOMER_STATE.EDIT && _this_1.customerState == CUSTOMER_STATE.FIRST) {
                ...
                else if (_this_1.customerState == CUSTOMER_STATE.FIRST && state$$1 == CUSTOMER_STATE.DISPLAY) {
        ...
        if (this.validationResult.isTrue()) {
            ...
            function (data) {
                ...
                if (_this.customerStore) {
                    ...
                    /** @type {?} */
                    var state$$1 = _this.edit_type == "add" ? CUSTOMER_STATE.ADD_SAVED : CUSTOMER_STATE.EDIT_SAVED;
                    _this.customerStore.setState(state$$1);
                }
